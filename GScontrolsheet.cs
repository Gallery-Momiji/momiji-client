                  ...
                  if (saveFileDialog1.ShowDialog() == DialogResult.OK)
                  {
                      ...
                      for (i = 0; i <= limit; i++)
                      {
                          ...
                          if (lastPage != currentPage)
                          {
                              ...
                              {
                                  MessageBox.Show("Unable to save file\n\n" + d.Message.ToString(), "File IO Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                              }
                          ...
                          if (!blank)
                          {
                              template = template.Replace("%PTITLE" + ActualPID.ToString() + "%", artwork.getCell("PieceTitle", i).Replace("'", "\\rquote ").Replace("’", "\\rquote "));
                              ...
                              template = template.Replace("%PSDC" + ActualPID.ToString() + "%", (artwork.getCell("PieceSDC", i) == "True" ? "YES" : "NO" ));
