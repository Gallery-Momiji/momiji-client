...
namespace Momiji
{
	public partial class frmMenu
	{
		...
		private global::Gtk.Action preferencesAction3;
		private global::Gtk.Action removeAction;
		private global::Gtk.Action closeAction;
		private global::Gtk.Action yesAction;
		private global::Gtk.Action noAction;
		private global::Gtk.Action propertiesAction4;
		...
		private global::Gtk.Action preferencesAction4;
		private global::Gtk.Action removeAction1;
		private global::Gtk.Action propertiesAction5;
		...
		private global::Gtk.Action revertToSavedAction4;
		...
		private global::Gtk.Action propertiesAction6;
		...
		protected virtual void Build ()
		{
			...
			this.propertiesAction = new global::Gtk.Action ("propertiesAction", global::Mono.Unix.Catalog.GetString ("_Pricing"), null, "gtk-properties");
			this.propertiesAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Pricing");
			w1.Add (this.propertiesAction, null);
			this.indexAction = new global::Gtk.Action ("indexAction", global::Mono.Unix.Catalog.GetString ("_Users"), null, "gtk-index");
			...
			this.preferencesAction3 = new global::Gtk.Action ("preferencesAction3", global::Mono.Unix.Catalog.GetString ("_Edit User"), null, "gtk-preferences");
			this.preferencesAction3.ShortLabel = global::Mono.Unix.Catalog.GetString ("Edit User");
			w1.Add (this.preferencesAction3, null);
			...
			this.yesAction = new global::Gtk.Action ("yesAction", global::Mono.Unix.Catalog.GetString ("Check _In"), null, "gtk-yes");
			this.yesAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check In");
			w1.Add (this.yesAction, null);
			this.noAction = new global::Gtk.Action ("noAction", global::Mono.Unix.Catalog.GetString ("Check _Out"), null, "gtk-no");
			this.noAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check Out");
			w1.Add (this.noAction, null);
			this.propertiesAction4 = new global::Gtk.Action ("propertiesAction4", global::Mono.Unix.Catalog.GetString ("Generate _Bidding Sheets"), null, "gtk-properties");
			this.propertiesAction4.ShortLabel = global::Mono.Unix.Catalog.GetString ("Generate Bidding Sheets");
			w1.Add (this.propertiesAction4, null);
			...
			this.executeAction = new global::Gtk.Action ("executeAction", global::Mono.Unix.Catalog.GetString ("_Manage"), null, "gtk-execute");
			this.executeAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Manage");
			w1.Add (this.executeAction, null);
			this.addAction1 = new global::Gtk.Action ("addAction1", global::Mono.Unix.Catalog.GetString ("_Add Artist"), null, "gtk-add");
			this.addAction1.ShortLabel = global::Mono.Unix.Catalog.GetString ("Add Artist");
			w1.Add (this.addAction1, null);
			this.preferencesAction4 = new global::Gtk.Action ("preferencesAction4", global::Mono.Unix.Catalog.GetString ("_Edit Artist"), null, "gtk-preferences");
			this.preferencesAction4.ShortLabel = global::Mono.Unix.Catalog.GetString ("Edit Artist");
			w1.Add (this.preferencesAction4, null);
			...
			this.propertiesAction5 = new global::Gtk.Action ("propertiesAction5", global::Mono.Unix.Catalog.GetString ("Edit _Merchandise"), null, "gtk-properties");
			this.propertiesAction5.ShortLabel = global::Mono.Unix.Catalog.GetString ("Edit Merchandise");
			w1.Add (this.propertiesAction5, null);
			this.revertToSavedAction = new global::Gtk.Action ("revertToSavedAction", global::Mono.Unix.Catalog.GetString ("Edit _Gallery Store Merchandise"), null, "gtk-revert-to-saved");
			...
			this.revertToSavedAction4 = new global::Gtk.Action ("revertToSavedAction4", global::Mono.Unix.Catalog.GetString ("_Check Sales Records"), null, "gtk-revert-to-saved");
			this.revertToSavedAction4.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check Sales Records");
			w1.Add (this.revertToSavedAction4, null);
			this.undoAction = new global::Gtk.Action ("undoAction", global::Mono.Unix.Catalog.GetString ("_Refunds"), null, "gtk-undo");
			...
			this.propertiesAction6 = new global::Gtk.Action ("propertiesAction6", global::Mono.Unix.Catalog.GetString ("Check _user activities"), null, "gtk-properties");
			this.propertiesAction6.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check user activities");
			w1.Add (this.propertiesAction6, null);
			this.printPreviewAction = new global::Gtk.Action ("printPreviewAction", global::Mono.Unix.Catalog.GetString ("Check latest _receipts"), null, "gtk-print-preview");
			this.printPreviewAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Check latest receipts");
			w1.Add (this.printPreviewAction, null);
			this.quitAction = new global::Gtk.Action ("quitAction", global::Mono.Unix.Catalog.GetString ("_Quit"), null, "gtk-quit");
			this.quitAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("_Quit");
			w1.Add (this.quitAction, null);
			this.printAction = new global::Gtk.Action ("printAction", global::Mono.Unix.Catalog.GetString ("Re-_Print Receipt"), null, "gtk-print");
			this.printAction.ShortLabel = global::Mono.Unix.Catalog.GetString ("Re-_Print Receipt");
			...
			this.UIManager.AddUiFromString ("<ui><menubar name='menubar3'><menu name='FileAction' action='FileAction'><menu name='preferencesAction' action='preferencesAction'><menuitem name='propertiesAction' action='propertiesAction'/><menu name='indexAction' action='indexAction'><menuitem name='addAction' action='addAction'/><menuitem name='preferencesAction3' action='preferencesAction3'/></menu><menuitem/></menu><menuitem name='closeAction' action='closeAction'/><menuitem name='quitAction' action='quitAction'/></menu><menu name='ArtistsAction' action='ArtistsAction'><menu name='yesAction' action='yesAction'><menuitem name='findAction10' action='findAction10'/><menuitem name='findAndReplaceAction7' action='findAndReplaceAction7'/></menu><menuitem name='noAction' action='noAction'/><menuitem/><menu name='executeAction' action='executeAction'><menuitem name='addAction1' action='addAction1'/><menu name='preferencesAction4' action='preferencesAction4'><menuitem name='findAction8' action='findAction8'/><menuitem name='findAndReplaceAction8' action='findAndReplaceAction8'/></menu><menu name='removeAction1' action='removeAction1'><menuitem name='findAction9' action='findAction9'/><menuitem name='findAndReplaceAction9' action='findAndReplaceAction9'/></menu><menu name='propertiesAction5' action='propertiesAction5'><menuitem name='findAction4' action='findAction4'/><menuitem name='findAndReplaceAction4' action='findAndReplaceAction4'/></menu><menu name='revertToSavedAction' action='revertToSavedAction'><menuitem name='findAction5' action='findAction5'/><menuitem name='findAndReplaceAction5' action='findAndReplaceAction5'/></menu><menu name='convertAction' action='convertAction'><menuitem name='findAction6' action='findAction6'/><menuitem name='findAndReplaceAction6' action='findAndReplaceAction6'/></menu></menu><menu name='propertiesAction4' action='propertiesAction4'><menuitem name='findAction' action='findAction'/><menuitem name='findAndReplaceAction' action='findAndReplaceAction'/></menu></menu><menu name='TreasuryAction' action='TreasuryAction'><menuitem name='revertToSavedAction4' action='revertToSavedAction4'/><menuitem name='undoAction' action='undoAction'/><menuitem name='printAction' action='printAction'/></menu><menu name='LogAction' action='LogAction'><menuitem name='propertiesAction6' action='propertiesAction6'/><menuitem name='printPreviewAction' action='printPreviewAction'/></menu><menu name='HelpAction' action='HelpAction'><menu name='dialogWarningAction' action='dialogWarningAction'><menuitem name='dialogQuestionAction' action='dialogQuestionAction'/><menuitem name='dialogQuestionAction1' action='dialogQuestionAction1'/><menuitem name='dialogQuestionAction2' action='dialogQuestionAction2'/></menu><menuitem name='aboutAction' action='aboutAction'/></menu></menubar></ui>");
